...
public class WindowResizer extends MouseAdapter {
	 ...
	 *            components to be automatically registered
	 */
	public WindowResizer(Insets dragInsets, Dimension snapSize,
	...
	public void setOndragEdgeListener(DragEdgeListener drag) {
		this.drag = drag;
